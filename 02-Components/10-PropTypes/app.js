...
Title.defaultProps = {title: 'Greeting'};
...
class AppComponent extends React.Component {
    ...
    componentDidMount = () => {
        setTimeout(() => this.setState({title: this.props.title}), 1000);
        this.loadCountries();
    };
...
const app = <AppComponent title="World Clock"/>;
...
// DEMO:
// - propTypes as static property of a class
